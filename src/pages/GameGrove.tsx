      ...
      >
        ...
        >
          <Box textAlign="center" mb={6} maxWidth="800px">
            ...
            >
              Master patterns through play - games that make learning fun
            </Typography>
          </Box>
        </motion.div>
                  ...
                  >
                    <CardContent sx={{ p: 4, height: '100%', display: 'flex', flexDirection: 'column', textAlign: 'center' }}>
                      ...
                      <Box flexGrow={1}>
                        ...
                        >
                          {game.id === 'flow-finder' ? 'Flow Finder' :
                           game.id === 'rhyme-quiz' ? 'Rhyme Quiz' :
                           game.id === 'melody-matcher' ? 'Melody Matcher' :
                           'Pattern Brain'}
                        </Typography>
                        <Typography 
                          variant="body1" 
                        ...
                        >
                          {game.id === 'flow-finder' ? 'Strategic rhyme pattern hunting with minesweeper-style gameplay' :
                           game.id === 'rhyme-quiz' ? 'Quick rhyme identification challenges for beginners' :
                           game.id === 'melody-matcher' ? 'Match musical patterns and rhythmic sequences' :
                           'Advanced pattern recognition training for experts'}
                        </Typography>
        ...
        >
          <Box textAlign="center" maxWidth="600px">
            <Typography variant="body2" color="text.secondary" sx={{ fontStyle: 'italic' }}>
              More games are being crafted in the forest. Check back soon for new adventures!
            </Typography>
          </Box>
        </motion.div>
      </Container>
