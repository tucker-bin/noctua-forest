...
const showAlphaPopup = () => {
  ...
  popup.innerHTML = `
    <div role="dialog" aria-modal="true" class="bg-[#4A5450] text-white p-5 md:p-8 rounded-xl w-full max-w-sm sm:max-w-md max-h-[75vh] overflow-y-auto relative">
      <!-- Close button -->
      ...
      <p class="text-gray-300 text-sm md:text-base mb-4 md:mb-6">You're invited to be a founding member of Noctua Forest, a new community for authors and readers. As an early Alpha member, your voice and submissions will directly influence the platform's growth.</p>
      
      <!-- Benefits list -->
      <div class="bg-[#3A4440] rounded-lg p-4 md:p-6 mb-5 md:mb-6">
        ...
        <ul class="space-y-2 md:space-y-3 text-sm md:text-base">
          <li class="flex items-start">
            <svg class="w-4 h-4 md:w-5 md:h-5 text-[#F58220] mt-1 mr-2 md:mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="space-y-3 md:space-y-4">
        <div class="relative">
          <input type="email" placeholder="Enter your email" required
            class="w-full px-3 h-11 md:h-12 rounded bg-[#5A6560] border border-[#7A8580] text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#F58220] focus:border-transparent text-sm md:text-base">
        </div>

        <button id="signupBtn" 
          class="w-full bg-[#F58220] hover:bg-[#E67615] text-white font-medium h-11 md:h-12 rounded transition duration-300 text-sm md:text-base">
